...
const CategoryList = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      if (responseData && responseData.Categories) {
        ...
        console.log(`res: ${JSON.stringify(responseData.Categories)}`);
      }
    } catch (error) {
      console.log(error);
    }
  ...
  return (
    <div className={`${data.categoryListDropdown ? "" : "hidden"} my-4`} style={{marginTop: 100}}>
      <h2 className=" font-bold">Categories</h2>
      <hr />
      <div className="py-1 grid grid-cols-8 sm:grid-cols-2 md:grid-cols-6 lg:grid-cols-8" >
            ...
            return (
              <Fragment key={index}>
                <div
                  ...
                  className="bg-white col-span-1 m-2 flex flex-col items-center justify-center space-y-2 cursor-pointer p-4"
