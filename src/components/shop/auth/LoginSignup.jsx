...
const LoginSignup = (props) => {
  ...
  return (
    <Fragment>
      ...
      >
        <div className="w-11/12 md:w-3/5 lg:w-2/4 relative space-y-4 bg-white p-6 md:px-12 md:py-6 rounded-lg">
          {login ? <Login /> : <Signup />}
          ...
          <div
            ...
            className="px-4 py-2 font-medium text-center cursor-pointer rounded"
          >
            {loginValue}
          </div>
          {/*  Modal Close Button */}
