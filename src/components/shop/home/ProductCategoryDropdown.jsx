...
const CategoryList = () => {
  ...
  return (
    <div className={`${data.categoryListDropdown ? "" : "hidden"} my-4 `}>
      {/* <hr /> */}
      <h1 className="font-bold text-center text-4xl my-6" style={{marginTop: 80}}>
        Top Categories
      </h1>
      <div className="py-1 grid grid-cols-8 sm:grid-cols-3 md:grid-cols-6 lg:grid-cols-12">
            ...
            return (
              <Fragment key={index}>
                <div
                  ...
                  className="col-span-1 m-2 flex flex-col items-center justify-center space-y-4 cursor-pointer"
                >
                  <img
                  ...
                  />
                  <div className="text-base text-center truncate font-bold" style={{fontSize: 12}}>{item.cName}</div>
                </div>
              </Fragment>
            );
          })
