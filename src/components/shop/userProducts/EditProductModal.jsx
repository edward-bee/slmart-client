...
import { editProduct, getAllUserProduct } from "./FetchApi";
...
const EditProductModal = (props) => {
  ...
  useEffect(() => {
    setEditformdata({
      ...
      pNegotiation: data.editProductModal.pNegotiation,
  ...
  const submitForm = async (e) => {
    ...
    try {
      ...
      let responseData = await editProduct(editformData, uid);
  ...
  return (
    <Fragment>
      ...
      <div
        ...
        } fixed top-8 left-0 z-30 w-full h-full bg-black opacity-50`}
      />
      {/* End Black Overlay */}
      ...
      <div
        className={`${
          data.editProductModal.modal ? "" : "hidden"
        } fixed inset-0 flex items-center z-30 justify-center overflow-auto mb-2 mt-2 mp-8`}
        style={{marginTop: '0.5rem', marginBottom: '0.5rem'}}

      >
        <div className="mt-32 md:mt-0 relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4 px-4 py-4 md:px-8" style={{borderRadius: 15}}>
          <div className="flex items-center justify-between w-full pt-4" >
            ...
            <span
              ...
              className="cursor-pointer text-gray-100 py-2 px-2 rounded-full bg-secondary-one"
...
<div className="flex space-x-1 py-4">
              <div className="w-1/2 flex flex-col space-y-1">
                ...
                <select
                  value={editformData.pNegotiation}
                  onChange={(e) =>
                    setEditformdata({
                      ...editformData,
                      error: false,
            ...
            <div className="flex flex-col space-y-1 w-full pb-4 md:pb-6 mt-4">
              <button
                ...
                type="submit"
                className="rounded-full bg-primary-one text-gray-100 text-lg font-medium py-2"
              >
                Update product
              </button>
            </div>
